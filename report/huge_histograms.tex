...
the cuda kernel has to work at small local histograms which fit into shared memory, and flush back into corresponding parts of the global histogram.
...
However, we have a flowchart of the code can be found in \Cref{fig:device-dia}.
...
The benchmark illustrated in \Cref{fig:graph2} and \Cref{fig:graph3}
...
\section{Discussion}
% TODO : better introduce the discussion section.
In this section, we give a short dicussion of the general problems that we have encountered.
...
%\subsection{} % MISSING : discussion about streaming.
